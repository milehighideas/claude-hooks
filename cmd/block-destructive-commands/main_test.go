...
func TestGitWhitelist(t *testing.T) {
	tests := []struct {
		...
		{"git worktree list", "git worktree list", false},
		{"git worktree add", "git worktree add /path branch", false},
		{"git worktree remove", "git worktree remove /path", true},
		{"git worktree prune", "git worktree prune", true},
